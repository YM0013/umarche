...
<div class="modal micromodal-slide" id="{{ $modal }}" aria-hidden="true">
  <div class="modal__overlay z-50 " tabindex="-1" data-micromodal-close> {{--z-50はzインデックスと呼ばれるものでzの後ろの数字が大きいほど画面では手前に表示されることになる--}}
    <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="{{ $modal }}}-title">{{--aria-labelledbyは視覚障害や聴覚障害の人用の動作を書くところ--}}
