<x-app-layout>
              ...
              <div class="p-6 bg-white border-b border-gray-200">
                 <div class="md:flex md:justify-around">
                    ...
                    <div class="md:w-1/2 ml-4">
                      ...
                      <d class="flex justify-around items-center">
                        <div>
  ...
  {{--
        この記述は、このペースのみswiperのライブラリを読み込ませるという処理になる
        app.jsに記述すれば、このサービス全体で適応することは出来るがswiperのライブラリは
        データ量が多いので必要なページのみ読み込むようにしている
        ちなみにapp.blade.phpを利用して読み込ませることも可能
  --}}
</x-app-layout>
