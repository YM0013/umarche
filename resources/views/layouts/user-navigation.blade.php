        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('user.items.index')" :active="request()->routeIs('usar.items.index')">
                        {{ __('ホーム') }}
                    </x-nav-link>
                    <x-nav-link :href="route('user.cart.index')" :active="request()->routeIs('usar.cart.index')">
                        カートを表示
                    </x-nav-link>
                </div>
            </div>
